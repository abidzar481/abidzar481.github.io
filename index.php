...
$user = "root";
$password = "";
$database = "db_crud2022";

//buat koneksi
$koneksi = mysqli_connect($server, $user, $password, $database) or die(mysqli_error($koneksi));

//kode otomatis
$q = mysqli_query($koneksi, "SELECT kode FROM tb_barang order by kode desc limit 1");
...
if (isset($_POST['bsimpan'])) {
    ...
    if (isset($_GET['hal']) == "edit") {
        //data akan di edit
        $edit = mysqli_query($koneksi, "UPDATE tb_barang SET
                                               nama = '$_POST[tnama]',
        ...
        $simpan = mysqli_query($koneksi, " INSERT INTO tb_barang (kode, nama, nm_penerima, asal, jumlah, satuan, tanggal_diterima)
                                            VALUE ( '$_POST[tkode]',
                                                    '$_POST[tnama]',                                         
            ...
            <div class="card-body">
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    if (isset($_POST['bcari'])) {
                        ...
                        $keyword = $_POST['tcari'];
                        $q = "SELECT * FROM tb_barang WHERE kode like '%$keyword%' or nama like '%$keyword%' or nm_penerima like '%$keyword%' or asal like '%$keyword%' order by id_barang desc";
                    } else {
